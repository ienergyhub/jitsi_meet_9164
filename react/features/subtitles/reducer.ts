...
import {
    REMOVE_TRANSCRIPT_MESSAGE, SEND_TRANSCRIPT_BITE, SEND_TRANSCRIPT_MESSAGE,
...
export interface ISubtitlesState {
    ...
    _sendTranscriptBite: any;
    _sendTranscriptText: any;
    _sendTranscriptCount: any;
}
