...
class HangupMenuButton extends Component<IProps> {
     jwt = APP.store.getState()['features/base/jwt'].jwt;
     decodeJwt = jwt_decode(this.jwt)
    /**
    ...
    componentDidUpdate(prevProps: Readonly<IProps>, prevState: Readonly<{}>, snapshot?: any) {
        ...
        if (this.props.runningTimer.toString() === this.decodeJwt.duration) {
...
const mapStateToProps = (state: IReduxState) => {
    const {runningTime} = state['features/base/conference'];
    return {
        runningTimer: runningTime
    }
}

export default connect(mapStateToProps)(translate(HangupMenuButton));
